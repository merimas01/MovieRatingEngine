...
- This engine automatically activates after 2 characters are entered (a white space string doesn't count). It matches any textual atrribute of the movie or TV show (title, description, cast) and can intelligently parse phrases such as: "5 stars", "at least 3 stars", "after 2016", "older than 5 years" etc. Search results are also sorted by rating. 
<img width="1892" height="902" alt="search" src="https://github.com/user-attachments/assets/3cf5097c-8f91-4f69-9430-48a7cc4abec5" />

- "No matches" message - Users are informed if no matches are found. 
...
### Prerequisites
- Visual Studio 22 (ASP .NET Core framework v8)
- Visual Studio Code
- Node.js (v22.14.0)
